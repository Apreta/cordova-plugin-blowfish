...
public class BinConverter
{
	...
	/**
	  ...
	  * (Apreta: hacked to little endian format)
	...
	{
		return ((int) buf[nOfs + 3] << 24)
			| (((int) buf[nOfs + 2] & 0x0ff) << 16)
			| (((int) buf[nOfs + 1] & 0x0ff) << 8)
			| ((int) buf[nOfs + 0] & 0x0ff);
	}
	...
	{
		buf[nOfs + 3] = (byte) ((nValue >>> 24) & 0x0ff);
		buf[nOfs + 2] = (byte) ((nValue >>> 16) & 0x0ff);
		buf[nOfs + 1] = (byte) ((nValue >>> 8) & 0x0ff);
		buf[nOfs + 0] = (byte) nValue;
	}
